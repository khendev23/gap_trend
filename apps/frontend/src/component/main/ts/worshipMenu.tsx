...
export default function WorshipMenu() {
    return (
        <section className="w-screen min-h-[30vh]">
            {/* 타이틀 박스 */}
            <div className="flex justify-between items-center text-black px-6 md:px-12 pt-4">
        ...
        "
            ...
            >
                ...
                <div className="flex gap-5 px-6 md:px-12">
                    {[1, 2, 3, 4, 5].map((num) => (
                        <Link href="/" key={num} className="snap-start">
                            <div
                                className="
                  shrink-0 w-[200px] px-2 text-center text-black
